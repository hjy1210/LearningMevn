...
## MathJax 3
[MathJax@3](http://docs.mathjax.org/en/latest/web/typeset.html#web-typeset) 的排版有相當的改變，MathJax.Hub.Queue 不見了，取而代之的是 MathJax.typeset 與 MathJax.typesetPromise。據此，製作了 mathjaxcomp.vue， 可用來輸入數學文章進行排版。

vue-mathjax 0.0.11 compatible with mathjax 2.7 , but Not with mathjax@3.